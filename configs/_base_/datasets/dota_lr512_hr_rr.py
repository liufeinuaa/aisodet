...
train_pipeline = [
    ...
    dict(type='LoadAnnotations_sr', with_bbox=True, box_type='qbox', with_hr_img=True),
...
#     format_only=True,
#     merge_patches=True,
#     outfile_prefix='./work_dirs/dotav1_Task1')
