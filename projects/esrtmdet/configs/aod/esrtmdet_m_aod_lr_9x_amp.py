...
# train
# python tools/train.py projects/esrtmdet/configs/aod/esrtmdet_m_aod_lr_9x_amp.py

# test
# python tools/test.py projects/esrtmdet/configs/aod/esrtmdet_m_aod_lr_9x_amp.py work_dirs/aisodet-ts/AOD/m.pth
