...
# train
# python tools/train.py projects/esrtmdet/configs/dota/esrtmdet_m_3x_dota_lr_amp.py

# test
# python tools/test.py projects/esrtmdet/configs/dota/esrtmdet_m_3x_dota_lr_amp.py work_dirs/aisodet-ts/DOTA/esrtmdet_m_3x_dota.pth
