...
class SR_HRSCDataset(BaseDataset):
    """
    我这里在 hrsc 数据集结构的基础上，引入 sr 分支需要 hr img
    ...
    def __init__(self,
                ...
                #  img_shape: Tuple[int, int] = (400, 400), # 在sr_dota 中默认使用 512x512 的原始图像
